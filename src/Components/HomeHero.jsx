  ...
  return (
    <>
      <style>{`
        ...
        /* Slide container height: smaller on phones, larger on desktop */
        .slide-container {
          height: 70vh;
          display: flex;
      ...
      >
          ...
          <SwiperSlide key={i}>
            <div className="slide-container">
              ...
              <div className="slide-content">
                {/* Typing animation with no cursor */}
                <TypeAnimation
                  sequence={heading}
                  speed={50}
                  repeat={Infinity}
        ...
        <button
          ref={prevRef}
          className="absolute top-1/2 left-4 md:left-8  cursor-pointer lg:left-12 w-12 h-12 md:w-14 md:h-14 z-30 bg-white/40 text-gray-900 font-bold text-xl md:text-2xl rounded-full hover:bg-white transition"
        ...
        <button
          ref={nextRef}
          className="absolute top-1/2 cursor-pointer right-4 md:right-8 lg:right-12 w-12 h-12 md:w-14 md:h-14 z-30 bg-white/40 text-gray-900 font-bold text-xl md:text-2xl rounded-full hover:bg-white transition"
